    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <form method="POST" action="{{ route('receptionist.patient.register.store') }}">
                    @csrf
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="medical_history" id="medical_history" rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 @error('medical_history') border-red-500 @enderror">{{ old('medical_history') }}</textarea>
